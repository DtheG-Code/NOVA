...
contextBridge.exposeInMainWorld('nova', {
  ...
  win: {
    ...
    dragStart: send('win:dragStart'),
    dragMove: send('win:dragMove'),
    dragEnd: send('win:dragEnd'),
  ...
  bookmarks: {
    ...
    setAllOpen: invoke('bm:setAllOpen'),
    find: invoke('bm:find'),
  ...
  vault: {
    ...
    setPin: invoke('vault:setPin'),
    removePin: invoke('vault:removePin'),
    unlockPin: invoke('vault:unlockPin'),
